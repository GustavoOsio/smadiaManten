...
class LaboratoryExamsPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(43, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(43, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(43, 'delete'));
    }
