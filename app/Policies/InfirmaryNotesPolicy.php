...
class InfirmaryNotesPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(50, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(50, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(50, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(50, 'delete'));
    }
