...
class InfirmaryEvolutionPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(46, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(46, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(46, 'update'));
    }
