...
class ClinicalDiagnosticsPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(40, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(40, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(40, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(40, 'delete'));
    }
