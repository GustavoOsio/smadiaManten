...
class SystemReviewPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(37, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(37, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(37, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(37, 'delete'));
    }
