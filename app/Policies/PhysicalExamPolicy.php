...
class PhysicalExamPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(38, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(38, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(38, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(38, 'delete'));
    }
