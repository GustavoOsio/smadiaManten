...
class FormulationAppointmentPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(47, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(47, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(47, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(46, 'delete'));
    }
