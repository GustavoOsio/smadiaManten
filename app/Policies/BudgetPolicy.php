...
class BudgetPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(19, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(19, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(19, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(19, 'delete'));
    }
