...
class MedicalEvolutionsPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(44, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(44, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(44, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(44, 'delete'));
    }
