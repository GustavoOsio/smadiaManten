...
class PatientPhotographsPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(52, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(52, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(52, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(52, 'delete'));
    }
