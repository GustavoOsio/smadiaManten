...
class BiologicalMedicinePlanPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(42, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(42, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(42, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(42, 'delete'));
    }
