...
class MeasurementsPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(39, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(39, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(39, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(39, 'delete'));
    }
