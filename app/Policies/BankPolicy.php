...
class BankPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(4, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(4, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(4, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(4, 'delete'));
    }
