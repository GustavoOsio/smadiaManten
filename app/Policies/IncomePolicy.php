...
class IncomePolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(17, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(17, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(17, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(17, 'delete'));
    }
