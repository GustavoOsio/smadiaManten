...
class InventoryAdjustmentPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(68, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(68, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(68, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(68, 'delete'));
    }
