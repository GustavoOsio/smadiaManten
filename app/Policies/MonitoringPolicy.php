...
class MonitoringPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(20, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(20, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(20, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(20, 'delete'));
    }
