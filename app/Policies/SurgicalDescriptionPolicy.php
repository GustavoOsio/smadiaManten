...
class SurgicalDescriptionPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(51, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(51, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(51, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(51, 'delete'));
    }
