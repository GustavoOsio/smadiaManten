...
class TreatmentPlanPolicy
{
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(41, 'visible'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(41, 'create'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(41, 'update'));
    }
    ...
    {
        return in_array($user->role_id, MenuRol::permissions(41, 'delete'));
    }
