...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="title-crud">
                <h2>Crear Ayuda Diagnostica</h2>
            </div>
            <div class="button-new">
                <a class="btn btn-primary" href="{{ route('diagnostic_aids.index') }}"> Atrás</a>
            </div>
        </div>
    </div>
    ...
    <form id="typesService" action="{{ route('diagnostic_aids.store') }}" method="POST">
        @csrf
