        ...
        <div class="modal-content">
            ...
            <form id="frmExport">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <select name="filter" id="filterExport_products" class="form-control">
                        ...
                        <div class="col-md-4 type-export" style="display: none">
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal" id="exportar_2" >Exportar</button>
                </div>
            </form>
        </div>
    </div>
