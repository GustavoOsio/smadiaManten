                        ...
                        <tr id="rowToClone-1">
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <input name="discount[]" type="text" id="price-d-1" data-id="1" placeholder="0" class="form-control"
                                       onkeyup="calcule(this, 'discount')" onkeypress="return soloNumeros(event);" readonly>
                                </div>
                            </td>
                            <td>
                                <div class="input-group">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" name="date_expiration" class="form-control" id="date" required>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div class="form-group">
                            <textarea name="additional" rows="4" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6">
