...
@section('content')
    ...
    <form id="formBudgetUpdate" method="POST">
        @csrf
        ...
        <div class="row">
                        ...
                        <tr id="rowToClone-{{ $i + 1 }}">
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ number_format(($item->percent * $item->price / 100) * $item->qty, 0, ',', '.') }}" id="price-d-{{ $i + 1 }}" data-id="{{ $i + 1 }}" placeholder="0" class="form-control"
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ number_format(($item->price - ($item->percent * $item->price / 100)) * $item->qty, 0, ',', '.') }}"
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="amount" value="{{ number_format($budget->amount, 0, ',', '.') }}" readonly onkeypress="return soloNumeros(event);" class="form-control" placeholder="0" id="validationTooltip" required>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <label for="date" class="c-primary font-weight-bold">Fecha de vencimiento</label>
                        <div class="input-group">
                            <input type="text" name="date_expiration" class="form-control" value="{{ $budget->date_expiration }}" id="date" required>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <label class="c-primary fw5">Adicionales</label>
                        <div class="form-group">
                            <textarea name="additional" rows="4" class="form-control">{{ $budget->additional }}</textarea>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <label class="c-primary fw5">Observaciones</label>
                        <div class="form-group">
                            <textarea name="comment" rows="4" class="form-control" required>{{ $budget->comment }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 mt-3 mb-4 ">
                <div class="row justify-content-md-center">
                    <div class="col-lg-5 col-md-6 margin-tb">
                        <div class="title-crud" id="cloneRow" data-id="{{ count($budget->items) }}">
