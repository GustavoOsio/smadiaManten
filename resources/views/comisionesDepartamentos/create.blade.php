...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="button-new">
                <a class="btn btn-primary" href="{{ route('comisionesDepartamentos.index') }}"> Atrás</a>
            </div>
        </div>
    </div>
    ...
    @endif
        ...
        <form id="typesService" action="{{ route('comisionesDepartamentos.store') }}" method="POST">
            @csrf
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                <div class="form-group">
                    <strong>Escoger departamento:</strong>
            ...
            <div class="expenses-add">
                <div class="form-expenses">
                    <div class="row">
                    <div class="separator"></div>
        <p class="title-form">Comisiones por ventas</p>
        <div class="line-form"></div>
                        <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                            <div class="row justify-content-md-center">
                                <div class="col-lg-3 col-md-4 margin-tb">
                                    <div class="form-group">
                                        <strong>Seleccione por procedimientos:</strong>
                                        <select name="Ventaservice1" id="Ventaservice1" class="form-control filter-schedule mt-3">
                    <option value="">Seleccione servicio</option>
                    @foreach($CenterCost as $service)
                    ...
                    @endforeach
                                ...
                                <div class="col-lg-2 col-md-5 margin-tb">
                                    <div class="form-group">
                                        ...
                                        <input value="" type="number" name="ventasPorcentajeDesde1" id="ventasPorcentajeDesde1" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-5 margin-tb">
                                    <div class="form-group">
                                        <strong>Porcentaje Hasta:</strong>
                                        <input value="" type="number" name="ventasPorcentajeHasta1" id="ventasPorcentajeHasta1" class="form-control ">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-5 margin-tb">
                                    <div class="form-group">
                                        <strong>Porcentaje de comision:</strong>
                                        <input type="number" name="ventasPorcentajeComision1" id="ventasPorcentajeComision1" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-lg-4 col-md-3 margin-tb">
                        <div class="title-crud" style="border: 0; text-align: center; float: none">
                            <h4 id="add-new"><span class="icon-new-02"><span class="path1"></span><span class="path2"></span><span class="path3"></span></span> Agregar Comision</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="expenses-add1">
                <div class="form-expensesProd">
                    <div class="row">
                    <div class="separator"></div>
        <p class="title-form">Comisiones por Procedimientos y/o aplicaciones</p>
        <div class="line-form"></div>
                        <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                            <div class="row justify-content-md-center">
                                <div class="col-lg-3 col-md-4 margin-tb">
                                    <div class="form-group">
                                        ...
                                        <select name="prodService1" id="prodService1" class="form-control filter-schedule mt-3">
                    <option value="">Seleccione servicio</option>
                    ...
                    @endforeach
                                ...
                                <div class="col-lg-2 col-md-5 margin-tb">
                                    <div class="form-group">
                                        ...
                                        <input value="" type="number" name="prodPorcentajeDesde1" id="prodPorcentajeDesde1" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-5 margin-tb">
                                    <div class="form-group">
                                        <strong>Cantidad Hasta:</strong>
                                        <input value="" type="number" name="prodPorcentajeHasta1" id="prodPorcentajeHasta1" class="form-control " >
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-5 margin-tb">
                                    <div class="form-group">
                                        <strong>Porcentaje de comision:</strong>
                                        <input type="number" name="prodPorcentajeComision1" id="prodPorcentajeComision1" class="form-control" >
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-5 margin-tb">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="prodComisionMeta1" id="prodComisionMeta1" class="form-control" >
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                <div class="row justify-content-md-center">
                    <div class="col-lg-4 col-md-3 margin-tb">
                        <div class="title-crud" style="border: 0; text-align: center; float: none">
                            <h4 id="add-new1"><span class="icon-new-02"><span class="path1"></span><span class="path2"></span><span class="path3"></span></span> Agregar Comision</h4>
                        </div>
                    </div>
                </div>
            </div>
