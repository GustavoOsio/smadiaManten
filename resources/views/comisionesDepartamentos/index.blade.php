...
@section('content')
@component("components.exportComisionesDpto", ["url"=>url("exports/exportComisionesDpto")]) @endcomponent
<meta name="csrf-token" content="{{ csrf_token() }}" />
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="title-crud mb-3">
                <h2>Comisiones Departamentos</h2>
            </div>
            <div class="button-new">
                                    <a class="btn btn-primary" href="{{ route('comisionesDepartamentos.create') }}"> Crear</a>
